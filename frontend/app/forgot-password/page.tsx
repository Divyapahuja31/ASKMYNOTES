...
export default function ForgotPasswordPage(): React.ReactElement {
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>): Promise<void> => {
        ...
        try {
            ...
            setSuccessMessage("If an account with that email exists, a password reset link has been sent. Check your inbox.");
        } catch {
    ...
    return (
        <main className="relative min-h-screen w-full text-slate-800 overflow-x-hidden font-sans selection:bg-yellow-300 selection:text-black flex items-center justify-center p-4">
            ...
            >
                ...
                >
                    <KeyRound size={56} className="text-yellow-500" strokeWidth={1.5} />
                </motion.div>
                ...
                <div className="relative group">
                    ...
                    <div className="relative bg-white border-3 border-slate-900 p-8 md:p-10 rounded-lg" style={{ filter: "url(#squiggle)" }}>
                        ...
                        <div className="text-center mb-10">
                            ...
                            <p className="mt-4 text-slate-500 font-medium">Enter your email and we&apos;ll send a reset link.</p>
                        </div>
                            ...
                            <div className="flex flex-col gap-1 mb-3 w-full">
                                <div className="relative group w-full">
                                    ...
                                    <div className="relative z-10 flex items-center px-4 py-3">
                                        <Mail className="w-5 h-5 mr-3 text-slate-400 group-focus-within:text-yellow-600 transition-colors" />
                                        <input
                                            type="email"
                                            name="email"
                                            placeholder="Student Email"
                                            value={email}
                                            onChange={(e) => { setEmail(e.target.value); setServerError(""); setSuccessMessage(""); }}
                        ...
                        <div className="mt-8 text-center text-sm font-medium text-slate-600">
                            ...
                            <Link
                                href="/login"
                                className="font-bold text-yellow-600 hover:text-yellow-700 decoration-wavy hover:underline underline-offset-4"
                            >
                                Log in here.
                            </Link>
                        </div>
